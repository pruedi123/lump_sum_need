...
if have_any:
    ...
    if src_kind == "LBM":
        ...
        order = order_lbm + order_spx
        pretty_lbm_both = {k: v + " (LBM)" for k, v in pretty_lbm.items()}
        pretty_spx_both = {k: v + " (SPX)" for k, v in pretty_spx.items()}
    ...
    desired_cols = ["Allocation", "Portfolio Name", "Required Lump Sum"]
