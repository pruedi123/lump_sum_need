...
if st.button("Compute required lump sum"):
    if df is None or not allocation_cols:
        ...
        st.write("Note: Results depend on historical data and may not predict future performance. Use with caution.")
        st.write("This is for educational purposes and not financial advice.")
        st.write("Data Source: Dimensional Fund Advisors. See https://www.dimensional.com/us-en/ for details.")
        st.write("Does not include fees or taxes. Assumes reinvestment of all returns. You can't invest in the index data itself. However you can find mutual funds or ETFs that closely mimic this data.")
