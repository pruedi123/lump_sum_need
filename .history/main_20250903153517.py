...
if st.button("Compute required lump sum"):
    if df is None or not allocation_cols:
        ...
        # Preserve original Excel column header before mapping to pretty labels
        results["Excel Column"] = results["Allocation"]
        ...
        # Reorder columns for display to include the original Excel header
        desired_cols = ["Allocation", "Excel Column", "Required Lump Sum", "Valid Windows", "Note"]
