...
st.caption("Computes the one‑time contribution needed to reach your goal with the selected confidence using historical factor windows.This model assumes that the future goal is in 'Today's Dollars' and does not include inflation adjustments.")
