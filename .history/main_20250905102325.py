...
.iris-tip .iris-bubble {
    ...
    background: #111; color: #fff; border-radius: 6px; box-shadow: 0 6px 18px rgba(0,0,0,0.25);
}
...
if have_any:
    ...
    st.subheader("Results (Compounded Annual Growth Rate, CAGR is net of inflation impact) in Today's Dollars)")
